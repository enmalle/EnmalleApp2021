...
public class CreyentePosCelula {
    ...
    public CreyentePosCelula() {
    }

    public CreyentePosCelula(String lider, String candidatos, String nominados, String asistentes, String idLider) {
        this.lider = lider;
