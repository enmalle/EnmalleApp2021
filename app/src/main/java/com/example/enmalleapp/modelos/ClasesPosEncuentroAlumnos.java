...
public class ClasesPosEncuentroAlumnos {
    ...
    public ClasesPosEncuentroAlumnos() {
    }

    public ClasesPosEncuentroAlumnos(String lider, String candidatos, String nominados, String asistentes, String idLider) {
        this.lider = lider;
    ...
    public String getNominados() {return nominados; }
