...
public class CreyentePreCelula {
    ...
    public CreyentePreCelula() {
    }

    public CreyentePreCelula(String lider, String candidatos, String nominados, String asistentes, String idLider) {
        this.lider = lider;
