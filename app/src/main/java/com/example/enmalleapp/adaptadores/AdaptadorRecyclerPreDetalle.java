...
public class AdaptadorRecyclerPreDetalle extends RecyclerView.Adapter <AdaptadorRecyclerPreDetalle.ViewHolderDatos>{
    ...
    public AdaptadorRecyclerPreDetalle(ArrayList<CreyentePreDetalle> listaDatosPreDetalle) {
        this.listaDatosPreDetalle = listaDatosPreDetalle;
    }

    @NonNull
    @Override
    public AdaptadorRecyclerPreDetalle.ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdaptadorRecyclerPreDetalle.ViewHolderDatos holder, final int position) {
